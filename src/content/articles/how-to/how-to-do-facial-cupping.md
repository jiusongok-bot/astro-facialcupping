---
title: "How to Do Facial Cupping: Beginner Guide & First Session Tips"
description: "Learn what you need, how to prepare, first session tips, cup sizes explained, and best oils for facial cupping. Start safely with this complete beginner guide."
section: "how-to"
status: "published"
...
1. **Remove all makeup** — use a gentle cleanser or micellar water to strip away makeup, sunscreen, and surface oils.
2. **Pat skin dry** — do not rub; a slightly damp face is fine, but excess water dilutes your oil layer.
...
Once you are comfortable with the sensation, follow this basic sequence. For a fully detailed walkthrough with timing and repetition counts, see our [step-by-step tutorial](/how-to/facial-cupping-step-by-step-tutorial).
...
For a complete breakdown of cupping methods for each zone, see the [facial cupping techniques library](/how-to/facial-cupping-techniques).
...
1. **Too much suction** — squeezing the cup too hard before placing it on the skin. Start lighter than you think you need to.
2. **Holding the cup still** — stationary suction causes bruising. Always keep the cup gliding.
3. **Skipping oil** — cupping on bare or dry skin creates friction and irritation. Oil is non-negotiable.
4. **Starting with small cups** — smaller cups concentrate suction and are harder to control. Begin with the largest cup.
5. **Overdoing it** — longer is not better. A focused 5-minute session outperforms a sloppy 20-minute one.

For a more detailed look at what can go wrong — and how to fix it — read our guide to [common facial cupping mistakes](/how-to/common-facial-cupping-mistakes).
...
Ready to go deeper? Explore our [step-by-step tutorial](/how-to/facial-cupping-step-by-step-tutorial) for a complete 10-minute routine, or browse the [technique library](/how-to/facial-cupping-techniques) for zone-specific methods.
